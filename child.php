...
<html>
    <head>
        ...
        <link rel="stylesheet" href="../dist/css/skins/skin-blue.min.css">
        <link rel="stylesheet" href="mainpage/dashboard_style.css">
    ...
    <body class="hold-transition skin-blue sidebar-collapse">
        <div class="wrapper">
            ...
            $sql_chart = "
            SELECT
	sum(registered_child_2yrs) AS registered_child_2yrs,
	sum(registered_child_0_6_month) AS registered_child_0_6_month,
	sum(
		registered_child_6_23_month
	) AS registered_child_6_23_month,
	sum(
		child_counselled_on_complementary_feeding
	) AS child_counselled_on_complementary_feeding,
	sum(
		child_counselled_about_breast_feeding
	) AS child_counselled_about_breast_feeding,
	ROUND(
		(
			(
				sum(
					...
					IFNULL(child_counselled_about_breast_feeding,0)
				)
			) * 100
		) / sum(registered_child_2yrs),
		2
	) AS result
FROM
	disbursement_link_indicator
WHERE
	period_year = $current_year " . $search_where;
            ...
            while ($row_chart = $result_chart->fetch_assoc()) {
                $registered_child_2yrs = $row_chart['registered_child_2yrs'];
                $registered_child_0_6_month = $row_chart['registered_child_0_6_month'];
                $registered_child_6_23_month = $row_chart['registered_child_6_23_month'];
                $child_counselled_on_complementary_feeding = $row_chart['child_counselled_on_complementary_feeding'];
                $child_counselled_about_breast_feeding = $row_chart['child_counselled_about_breast_feeding'];
                                            ...
                                            <table class="tbl1">
                                                <tr>
                                                    <td class="fst_cell1" width="100%"  align="center">
                                                        <div class="main_foot">HSSP DLR 13.4: Percentage of Registered Pregnant Mothers Receiving Specified Child Nutrition Services</div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="fst_cell1" width="100%"  align="center">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-4 col-sm-6 col-xs-12">
                                                                <div class="info-box buttontype">
                                                                    <span class="info-box-icon lg-icon"><img src="../files/icons/r_child.png"/></span>

                                                                    <div class="info-box-content">
                                                                        <span class="info-box-number"><?php echo number_format($registered_child_2yrs); ?>
                                                                        </span>
                                                                        <p>Registered child (0-23 months)</p>
                                                                    </div>
                                                                    <!-- /.info-box-content -->
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4 col-sm-6 col-xs-12">
                                                                <div class="info-box buttontype">
                                                                    <span class="info-box-icon lg-icon"><img src="../files/icons/newborn_child.png"/></span>

                                                                    <div class="info-box-content">
                                                                        <span class="info-box-number"><?php echo number_format($registered_child_0_6_month); ?>
                                                                        </span>
                                                                        <p>Registered child 0 to 6 months</p>
                                                                    </div>
                                                                    <!-- /.info-box-content -->
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4 col-sm-6 col-xs-12">
                                                                <div class="info-box buttontype">
                                                                    <span class="info-box-icon lg-icon"><img src="../files/icons/child.png"/></span>

                                                                    <div class="info-box-content">
                                                                        <span class="info-box-number"><?php echo number_format($registered_child_6_23_month); ?>
                                                                        </span>
                                                                        <p>Registered child 6 to 23 months</p>
                                                                    </div>
                                                                    <!-- /.info-box-content -->
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4 col-sm-6 col-xs-12">
                                                                <div class="info-box buttontype">
                                                                    <span class="info-box-icon lg-icon"><img src="../files/icons/complementary_feeding.png"/></span>

                                                                    <div class="info-box-content">
                                                                        <span class="info-box-number"><?php echo number_format($child_counselled_on_complementary_feeding); ?>
                                                                        </span>
                                                                        <p>Child counselled on complementary feeding</p>
                                                                    </div>
                                                                    <!-- /.info-box-content -->
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4 col-sm-6 col-xs-12">
                                                                <div class="info-box buttontype">
                                                                    <span class="info-box-icon lg-icon"><img src="../files/icons/children_malnutrition.png"/></span>

                                                                    <div class="info-box-content">
                                                                        <span class="info-box-number"><?php echo number_format($child_counselled_about_breast_feeding); ?>
                                                                        </span>
                                                                        <p>Child counselled about breast feeding</p>
                                                                    </div>
                                                                    <!-- /.info-box-content -->
                                                                </div>
                                                            </div>
