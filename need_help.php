	...
	<div class="container">
		<div class="content">
			<span class="form-info">
				<h3>Help Needed / साहयताचाहिन्छ</h3>
...
<br />
			...
			<div class="row">
					...
					<div class="col-lg-12">
						<label> Other Information (please write details of all information, including links to pictures or more information) / अन्य</label><br />
